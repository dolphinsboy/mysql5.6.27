...
my $ldata   = '/home/guosong/mysql5627/data';
my $execdir = '/home/guosong/mysql5627/bin';
my $bindir  = '/home/guosong/mysql5627/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/home/guosong/mysql5627/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/home/guosong/mysql5627/include', "include/mysql", "include");
